...
<head>
    ...
    <title>Pendidikan Internasional</title>
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link bg-dark text-white' href='pendidikan_internasional.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
